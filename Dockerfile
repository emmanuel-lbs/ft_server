...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2021/03/02 10:13:33 by elabasqu          #+#    #+#              #
#    Updated: 2021/03/08 10:55:38 by elabasqu         ###   ########lyon.fr    #
#                                                                              #
# **************************************************************************** #
...
RUN		openssl req -x509 -nodes -days 365 -newkey rsa:2048 -subj "/C=FR/ST=Auvergne-Rhône-Alpes/L=Lyon/emailAddress=elabasqu@student.42lyon.fr" -keyout ./etc/ssl/certs/localhost.key -out ./etc/ssl/certs/localhost.crt
